...
public class DatabaseInitializer {
    ...
    /**
     *<b>initialize database and Performs automatic data migration</b>
     * <p>checks if a database with the same name exist </p>
     * <p>if it doesn't exist it creates one </p>
     */
    @PostConstruct
    @Profile({"local"})
    ...
    /**
     *<p>Performs automatic data migration</p>
     */
    @Bean
