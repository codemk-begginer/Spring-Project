...
public class OperationServiceImpl implements OperationService {
    ...
    public OperationDto create(OperationDto dto) {
        ...
        Animal animal = animalRepository.findById(dto.getAnimalId()).orElseThrow(
                () -> new NotFoundException("animal "+dto.getAnimalId())
        );

        Operation operation = operationMapper.toEntity(dto);
        operation.setHorodatage(LocalDateTime.now());
    ...
    @Override
    public List<OperationDto> findByAnimal(Long animalId) {
    ...
    @Override
    public List<HistoriqueModification> getHistoriqueModifications(Long operationId) {
