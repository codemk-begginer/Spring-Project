...
public class NaissanceServiceImpl implements NaissanceService {
    ...
    public NaissanceDto create(NaissanceDto dto) {
        Ferme ferme = fermeRepository.findById(dto.getFermeId()).orElseThrow(
                () -> new NotFoundException("ferme "+dto.getFermeId())
        );

        Croisement croisement = croisementRepository.findById(dto.getCroisementId())
                .orElseThrow(() -> new NotFoundException("Croisement", dto.getCroisementId()));

        Naissance naissance = naissanceMapper.toEntity(dto);
        naissance.setDateNaissance(dto.getDateNaissance() != null ? dto.getDateNaissance() : LocalDate.now());
...
//        }
        ...
        historiqueService.enregistrerModification(
                ...
                "Création",
                null,
                "Naissance enregistrée (Nb porcelets : " + dto.getNbVivant() + ")",
    ...
    @Override
    public NaissanceDto getById(Long id) {
    ...
    @Override
    public List<NaissanceDto> getByCroisement(Long croisementId) {
    ...
    @Override
    public List<HistoriqueModification> getHistoriqueModifications(Long naissanceId) {
