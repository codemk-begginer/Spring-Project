...
public class TransactionServiceImpl implements TransactionService {
    ...
    @Override
    public tech.steve.essaie.dto.TransactionDto create(tech.steve.essaie.dto.TransactionDto dto) {
    ...
    @Override
    public tech.steve.essaie.dto.TransactionDto update(Long id, tech.steve.essaie.dto.TransactionDto dto) {
    ...
    @Override
    public tech.steve.essaie.dto.TransactionDto findById(Long id) {
    ...
    @Override
    public List<tech.steve.essaie.dto.TransactionDto> findByAnimalId(Long animalId) {
